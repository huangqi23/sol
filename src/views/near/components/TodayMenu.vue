...
<script type="text/javascript">
    ...
    export default {
        ...
        watch: {
            menuDown() {
                 let all = '全部'//this.$t('eat.all')
                 let close = '收起'//this.$t('eat.close')
        ...
        methods: {
            ...
            async _initData() {
                ...
                // }
                //现实现，方法有了以后还原
                this.todayMenuCategoryLists = [{id:1,name:"sssssssssss"},{id:2,name:"aaaaaaaaaaa"},{id:3,name:"bbbbbbbbb"},{id:4,name:"cccccccccccccccc"}]
                this._initMenuTitleScroll()
